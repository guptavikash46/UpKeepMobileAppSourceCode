...
public class deleteSpendings2 extends AppCompatActivity {
ListView listView;
...
String pos, RealID;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.delete_layout2);
        init();
        mainAction();
    }

    public void init(){
      listView = findViewById(R.id.listview_deleteSpend2);
    ...
    public void mainAction(){
          ...
          id1 = cursor.getColumnIndex(Tableinfo.spending2detail.COL1);
          ...
          listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
              ...
              public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                     ...
                     itempos = position;
                  cursor = dbhelper.SupplyID2(pos);
                  id1 = cursor.getColumnIndex(Tableinfo.spending2detail.COL0);
                  while (cursor.moveToNext()){
    ...
    public void dialogactivity(){
        ...
        dialg.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dbhelper.deleteData2(Integer.parseInt(RealID));
