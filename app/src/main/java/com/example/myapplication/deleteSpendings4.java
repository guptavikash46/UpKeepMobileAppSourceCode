...
public class deleteSpendings4 extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.deletespendings4);
        init();
        mainAction();
    }

    public void init(){
        listView = findViewById(R.id.listViewdeleteSpend4);
    ...
    public void mainAction(){
        ...
        id1 = cursor.getColumnIndex(Tableinfo.spending4detail.COL1);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                itempos = position;
                cursor = dbhelper.SupplyID4(pos);
                id1 = cursor.getColumnIndex(Tableinfo.spending4detail.COL0);
                while (cursor.moveToNext()){
    ...
    public void dialogactivity(){
        ...
        dialg.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                dbhelper.deleteData4(Integer.parseInt(RealID));
